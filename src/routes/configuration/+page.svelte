	...
	<section class="settings">
		...
		<form>
			...
			<div id="manage-settings">
				...
				<button id="stop" type="button" class="inactive">STOP</button>
			</div>
		</form>
	</section>
					...
					{#each packets as packet}
						<li>
							{#if $showPackets.includes(packet)}
								<input type="checkbox" name={packet} checked on:change={updatePackets} />
							{:else}
...
<style>
  ...
  form:invalid #start, button.inactive {
